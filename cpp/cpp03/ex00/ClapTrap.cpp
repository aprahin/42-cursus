...
{
	std::cerr << _GREY << _DIM << "Default ClapTrap destructor called"
	<< _END << std::endl;
	return ;
}
...
{
	std::cerr << _GREY << _DIM << "Named ClapTrap constructor called for "
	<< _YELLOW << name
	<< _END << std::endl;
	return ;
}
...
{
	std::cerr << _GREY << _DIM << "Multiple values ClapTrap constructor called with values "
...
void	ClapTrap::attack(const std::string &target)
{
	...
	{
		std::cout << _GREEN << this->_name << _WHITE << " attacks " << _RED
